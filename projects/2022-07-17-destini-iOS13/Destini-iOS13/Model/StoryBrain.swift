...
struct StoryBrain {
    ...
    func getStory() -> String {
        return self.stories[currentStory].title
    }
    
    func getChoice1() -> String {
        return self.stories[currentStory].choice1
    }
    
    func getChoice2() -> String {
        return self.stories[currentStory].choice2
    }
    
    mutating func chooseStory(_ buttonValue: String) {
        if buttonValue == stories[currentStory].choice1 {
